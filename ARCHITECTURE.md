...
3. **Notification System**
   ...
   - Events include: `OnAudioDescriptionChanged`, `OnPreferredAudioLanguagesChanged`,
     `OnCaptionsChanged`, `OnPreferredCaptionsLanguagesChanged`,
     `OnPreferredClosedCaptionServiceChanged`, `OnPresentationLanguageChanged`,
     `OnHighContrastChanged`, `OnVoiceGuidanceChanged`, `OnVoiceGuidanceRateChanged`,
     `OnVoiceGuidanceHintsChanged`, `OnPrivacyModeChanged`, `OnPinControlChanged`,
     `OnViewingRestrictionsChanged`, `OnViewingRestrictionsWindowChanged`,
     `OnLiveWatershedChanged`, `OnPlaybackWatershedChanged`,
     `OnBlockNotRatedContentChanged`, `OnPinOnPurchaseChanged`,
     `OnContentPinChanged`, `OnScreenReaderSpeedChanged`
...
4. **Accessibility Settings**
   ...
   - Screen reader speed (uint8: reading pace for screen reader TTS)
