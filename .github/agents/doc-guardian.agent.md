...
3. Push branch and open a PR to the upstream repository rdkcentral/entservices-usersettings base branch develop:
   ...
   - IMPORTANT: The base repository MUST be rdkcentral/entservices-usersettings, NOT the fork where the workflow runs
