...
CRITICAL: The documentation PR must be created against the **rdkcentral/entservices-usersettings** repository, NOT the fork where this issue was created.

1. **Clone and work with rdkcentral repository**:
   - Repository: `rdkcentral/entservices-usersettings`
   - Base branch: `develop`
   - NOT the fork (melhar098/entservices-usersettings or wherever this issue was created)

2. Create a new git branch in rdkcentral repository: `doc-update/<source-branch>-docs`
...
4. Push branch to **rdkcentral/entservices-usersettings** and open PR:
   - **IMPORTANT**: Target repository: `rdkcentral/entservices-usersettings`
   - Base branch: `develop`
   - Compare branch: `doc-update/<source-branch>-docs`
   - Title: `[DOCS] Documentation updates for PR #<original-pr>`
   - Description: 
     - List of documentation files updated
     - Summary of changes made
     - Link to original PR (which may be in a fork)
